...
const styles = StyleSheet.create({
  ...
  tile: {
    ...
    borderRadius:12, padding:12, marginRight:10, marginBottom:10,
...
const frc = StyleSheet.create({
  ...
  selectText: { color: UI.title, fontSize: 16, fontWeight: "600" },
  ...
  tileValue: { color: TOK.foreground, fontWeight: "800", fontSize: 18 },
  tileLabel: { color: TOK.mutedFg, marginTop: 2, fontSize: 12 },
